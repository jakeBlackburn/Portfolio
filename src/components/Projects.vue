<template>
    <div class="projects-container">
        ...
        <p class="projects-overview">Lorem ipsum thigng naj Lorem ipsum thigng naj Lorem ipsum thigng naj Lorem ipsum thigng naj Lorem ipsum thigng naj Lorem ipsum thigng naj Lorem ipsum thigng naj. Select a project to read its description in detail.</p>
        <div class="grid">  
